...
namespace ExePABD {
    ...
    public partial class ProdiTIDataSet : global::System.Data.DataSet {
        ...
        public partial class MahasiswaDataTable : global::System.Data.TypedTableBase<MahasiswaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public MahasiswaRow AddMahasiswaRow(string NIM, string Sex, string PhoneMhs) {
...
namespace ExePABD.ProdiTIDataSetTableAdapters {
    ...
    public partial class MahasiswaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [HRD].[Mahasiswa] WHERE (([NIM] = @Original_NIM) AND ((@IsNull_Sex = " +
                "1 AND [Sex] IS NULL) OR ([Sex] = @Original_Sex)) AND ((@IsNull_PhoneMhs = 1 AND " +
                "[PhoneMhs] IS NULL) OR ([PhoneMhs] = @Original_PhoneMhs)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [HRD].[Mahasiswa] ([NIM], [Sex], [PhoneMhs]) VALUES (@NIM, @Sex, @Pho" +
                "neMhs);\r\nSELECT NIM, Sex, PhoneMhs FROM HRD.Mahasiswa WHERE (NIM = @NIM)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [HRD].[Mahasiswa] SET [NIM] = @NIM, [Sex] = @Sex, [PhoneMhs] = @PhoneMhs WHERE (([NIM] = @Original_NIM) AND ((@IsNull_Sex = 1 AND [Sex] IS NULL) OR ([Sex] = @Original_Sex)) AND ((@IsNull_PhoneMhs = 1 AND [PhoneMhs] IS NULL) OR ([PhoneMhs] = @Original_PhoneMhs)));
SELECT NIM, Sex, PhoneMhs FROM HRD.Mahasiswa WHERE (NIM = @NIM)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT NIM, Sex, PhoneMhs FROM HRD.Mahasiswa";
        ...
        public virtual int Delete(string Original_NIM, string Original_Sex, string Original_PhoneMhs) {
            ...
            if ((Original_PhoneMhs == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_PhoneMhs));
            }
        ...
        public virtual int Insert(string NIM, string Sex, string PhoneMhs) {
            if ((NIM == null)) {
            ...
            if ((PhoneMhs == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(PhoneMhs));
            }
        ...
        public virtual int Update(string NIM, string Sex, string PhoneMhs, string Original_NIM, string Original_Sex, string Original_PhoneMhs) {
            if ((NIM == null)) {
                throw new global::System.ArgumentNullException("NIM");
            }
            else {
            ...
            if ((PhoneMhs == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(PhoneMhs));
            }
            if ((Original_NIM == null)) {
                throw new global::System.ArgumentNullException("Original_NIM");
            }
            ...
            if ((Original_PhoneMhs == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_PhoneMhs));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Sex, string PhoneMhs, string Original_NIM, string Original_Sex, string Original_PhoneMhs) {
            return this.Update(Original_NIM, Sex, PhoneMhs, Original_NIM, Original_Sex, Original_PhoneMhs);
        }
    }
